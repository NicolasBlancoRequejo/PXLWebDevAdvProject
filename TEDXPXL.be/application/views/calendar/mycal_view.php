						...
						<div class="modal-header" style="text-align: center">
							...
							<script type="text/javascript">
								$('.calendar .day').click(function() {	
									...
									$.get('http://localhost/TEDXPXL/mycal/getLocation/'+encodeURI(day_data), function(data){$('#h3comment').text("Location: " + data)});	
			...
			<div class="modal-dialog">
				...
				<div class="modal-body" style="text-align: center">
					...
					<div class="form-group">								
						...
						<div id="locationField" class="col-sm-10">
							<input id="autocomplete" onFocus="geolocate()" type="text" name="locatie"></input>
						</div>
					</div>
					<?php
						echo form_close();
